...
<table cellspacing="0" cellpadding="0" width="100%" style="margin-top:15px;" class="table tableblock hidetableblock form-data">
        <thead>
        <tr>
        <th colspan="2">{l s='Subscribers' mod='sendinblue'}</th>
        </tr>
        </thead>
        <tbody><tr>
  ...
  <div class="form-group manage_subscribe_block">
    <div>
      ...
      <label for="no_follow_email" class="radio-label"> {l s='No confirmation email' mod='sendinblue'}</label>
    </div>
  ...
  <div class="form-group manage_subscribe_block">
    <div class="col-md-10">
      ...
      <label for="follow_mail" class="radio-label"> {l s='Simple confirmation email' mod='sendinblue'}</label><span title="{l s='This confirmation email is one of your SMTP templates. By default, we have created a Default Template - Single Confirmation.' mod='sendinblue'}" class="toolTip"></span>
    </div>
  ...
  <div class="form-group manage_subscribe_block">
    <div style="padding: 0px;" class="col-md-10">
      ...
      <label for="double_optin" class="radio-label"> {l s='Double confirmation email' mod='sendinblue'}</label>
    ...
    <div class="inner_manage_box" {if isset($radio_val_option) && $radio_val_option == "doubleoptin"} style="display:block;" {/if}> 
      ...
      <div id="create-doubleoptin-templates">
        <p style="width: 90%;text-align: justify;text-justify: inter-word;">{l s='An email containing a double opt-in link will be sent after the form is submitted. Subscribers will be added to the selected list(s) only after clicking the double opt-in link. (Recommended for GDPR compliance)' mod='sendinblue'}</p></div>
      ...
      <div style="float:left;">
        ...
        <a style="color: #555;font-weight: bold;" aria-controls="mail-doubleoptin-redirect" href="#mail-doubleoptin-redirect"> {l s='Confirmation page' mod='sendinblue'} </a> 
        ...
        <div id="mail-doubleoptin-redirect" class="collapse">
          ...
          {l s='Redirect your contacts to a landing page or to your website once they have submitted the form with their details.' mod='sendinblue'}</p>
      ...
      <div style="float:left;">
        ...
        <a style="color: #555;font-weight: bold;" aria-controls="doubleoptin-final-confirm" aria-expanded="false" data-toggle="collapse" href="#doubleoptin-final-confirm"> {l s='Final confirmation email' mod='sendinblue'} </a>
        </div>
        <div class="clearfix"></div>
        <div style="padding-left: 10px;" id="doubleoptin-final-confirm" class="collapse">
          <p>{l s='Once a contact has clicked on the double opt-in link, send them a final confirmation email.' mod='sendinblue'}</p>
