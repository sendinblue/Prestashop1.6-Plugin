...
<table width="100%" cellspacing="0" cellpadding="0" style="margin-top:15px;margin-bottom:15px;" class="table form-data">
   <thead>
      <tr>
         <th colspan="2">{l s='SMS' mod='sendinblue'}</th>
      </tr>
   </thead>
   <tbody>
      <tr>
                     ...
                     {if $current_credits_sms >= $Sendin_Notify_Value}
                        ...
                        {else}
                        <span style="margin-bottom:10px; font-weight:bold; color: #585A69;">{l s='You have ' mod='sendinblue'} <strong  style="color:#F00; ">{$current_credits_sms|floatval}</strong> {l s=' SMS credits. To buy more, click here.' mod='sendinblue'}<a target="_blank" href ="{l s='https://www.sendinblue.com/pricing' mod='sendinblue'}" >{l s=' here' mod='sendinblue'}</a>.</span>
                        {/if}
                     {else}
                     		{if $current_credits_sms >= $Sendin_Notify_Value}
                     ...
                     {/if}   
                        <br/><br/>
                       <label>{l s='Do you want to receive an email when SMS credits are low?' mod='sendinblue'}</label>
         ...
         <td>
            <div id="tabs_wrapper">
               <div id="tabs_container">
                  <ul id="tabs">
                     <li class="active"><a href="#tab1">{l s='Send an order confirmation SMS notification' mod='sendinblue'}</a></li>
                     <li><a href="#tab2">{l s='Send a shipment confirmation SMS notification' mod='sendinblue'}</a></li>
                     <li><a href="#tab3">{l s='Send a SMS campaign' mod='sendinblue'}</a></li>
                  </ul>
               </div>
